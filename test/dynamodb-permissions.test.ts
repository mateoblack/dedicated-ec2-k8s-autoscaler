...
describe('DynamoDB Permissions for etcd Lifecycle Lambda', () => {
  ...
  test('Lambda execution role has DynamoDB permissions', () => {
    // Check that the Lambda has DynamoDB permissions granted via grantReadWriteData
  ...
  test('Lambda function has execution role attached', () => {
