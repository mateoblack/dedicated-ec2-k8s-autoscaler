...
describe('EC2 Permissions for etcd Lifecycle Lambda', () => {
  ...
  test('Lambda execution role has EC2 describe permissions', () => {
  ...
  test('Lambda execution role has AutoScaling permissions', () => {
    template.hasResourceProperties('AWS::IAM::Policy', {
      PolicyDocument: {
        Statement: Match.arrayWith([
          Match.objectLike({
